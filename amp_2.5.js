define(['pipAPI','underscore'], function(APIConstructor, _) {
	...
	**/
	...
	function ampExtension(options)
	{
		...
		var layout2 = [
            {media:{image:'https://github.com/haverfordismlab/picode/blob/main/Thumbs%20down.jpg'}, size:{height:48,width:30}, location:{right:0}, data:{handle:'right'}},
			{media:{image:'https://github.com/haverfordismlab/picode/blob/main/Thumbs%20up.png'}, size:{height:48,width:30}, location:{left:0}, data:{handle:'left'}},

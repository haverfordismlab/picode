define(['pipAPI','underscore'], function(APIConstructor, _) {
	...
	**/
	...
	function ampExtension(options)
	{
		...
		var layout2 = [
            {media:{image:'Thumbs down.jpg'}, size:{height:48,width:30}, location:{right:0}, data:{handle:'right'}},
			{media:{image:'Thumbs up.png'}, size:{height:48,width:30}, location:{left:0}, data:{handle:'left'}},

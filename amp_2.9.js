	...
	function ampExtension(options)
	{
		...
		var ampObj = 
		{
			...
			base_url : {//Where are your images at?
				image : 'https://cdn.jsdelivr.net/gh/haverfordismlab/picode/'
			}, 
		...
		var layout2 = [
            {media:{image:'Thumbs%20down.jpg'}, size:{height:48,width:30}, location:{right:0}, data:{handle:'right'}},
			{media:{image:'Thumbs%20up.png'}, size:{height:48,width:30}, location:{left:0}, data:{handle:'left'}},
